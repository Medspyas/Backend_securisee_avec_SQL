...
class ClientManager:
    ...
    Utiliser principalement par les commerciaux.
    ...
    def create_client(
        self, full_name, email, phone_number, company_name, commercial_id
    ):
    ...
    def check_client_exists(self, email, phone):
        return (
            ...
            .filter((Client.email == email) | (Client.phone_number == phone))
            .first()
            is not None
        )
