...
"""
    Tests pour la gestion des jetons JWT dans le module 'token_user.py':
    - création de token  à partir d'un utilisateur,
    - lecture et décodage corrects du token depuis le fichier local.
"""
