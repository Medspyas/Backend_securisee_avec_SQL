...
"""
    Ce fichier regroupe les fonctions utilitaires utilisées dans tout le projet.
    Il contient notamment :
        - des fonctions de validation (emails, dates, nombres),
        - le hash et la vérification des mots de passe.

    Utilisé pour centraliser les traitements communs et réutilisables.
